...
function ResetPassword() {
  ...
  return (
    <div className="max-w-[350px] my-52 mx-auto w-full shadow-md rounded-xl py-7 md:items-start">
      ...
      <form onSubmit={handleResetPassword} className="px-4">
        ...
        <button type="submit" className="btn bg-green-500 text-slate-200 mt-3">
          Reset
        </button>
      </form>
    </div>
